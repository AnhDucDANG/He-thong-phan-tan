...
class Booking(Document):
    user_id: str    # Liên kết với Service 1 (User)
    car_id: str     # Liên kết với Service 2 (Vehicle)
    ...
    # Giá thuê
    book_price: float
    daily_rate: float   # Giá thuê theo ngày, lấy ở vehicles
    total_days: int     # Số ngày thuê
